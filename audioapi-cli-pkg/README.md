...
```console
audioapi_cli enhance-file --api-token="my-user-key" --endpoint-url="oaiw7rf0af.execute-api.us-east-1.amazonaws.com/debug" --src-type=local --src-path="/home/user/my_audio_files/example.wav"
```
...
```console
audioapi_cli enhance-file --api-token="my-user-key" --endpoint-url="oaiw7rf0af.execute-api.us-east-1.amazonaws.com/debug" --src-type=local --src-path="/home/user/my_audio_files/example.wav" --no-download --retention=480
```
